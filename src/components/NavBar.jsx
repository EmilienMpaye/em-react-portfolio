...
{ id:5,
  ...
  return (
    <div className="flex px-5 justify-between items-center w-full h-15  text-yellow-600 bg-black fixed">
 <div>
 <h1 className='text-3xl font-signature mt-2'>Emilien</h1>
 </div>
 ...
 {links.map(({id,link})=>(
  ...
  key={id} className='px-4 cursor-pointer capitalize font-medium
   text-yellow-500 hover:scale-105 duration-200'>
 ...
 left-0 w-full h-screen bg-gradient-to-b
